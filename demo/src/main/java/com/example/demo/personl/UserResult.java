...
public class UserResult {
    ...
    public static UserResult errorMsg(String msg) {
        return new UserResult(500, msg, null);
    }

    public static UserResult errorMap(Object data) {
        return new UserResult(501, "error", data);
    }

    public static UserResult errorTokenMsg(String msg) {
        return new UserResult(502, msg, null);
    }

    public static UserResult errorException(String msg) {
        return new UserResult(555, msg, null);
    }
